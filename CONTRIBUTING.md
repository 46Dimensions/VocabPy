...
You can create a new issue on the [Vocabulary Plus Issues page](https://github.com/46Dimensions/VocabularyPlus/issues/new). Below are guidelines on how to do this effectively.

### Check if the issue already exists

Before creating an issue, please search in [Open Issues](https://github.com/46Dimensions/VocabularyPlus/issues/) to see if a similar issue or feature requests exists already.
...
You can also use the ['Bug Report' issue template](https://github.com/46Dimensions/VocabularyPlus/blob/1.3.0/.github/ISSUE_TEMPLATE/bug-report.md) to help with creating a good bug report.
