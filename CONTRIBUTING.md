...
## Creating Issues
Have you found a reproducible problem in Vocabulary Plus or have a request for a feature? Use an issue to tell us.

You can create a new issue [here](https://github.com/46Dimensions/VocabularyPlus/issues/new). Below are guidelines on how to do this effectively.

### Make sure you are filing the isssue in the correct repository
If the issue is about Vocabulary Plus Version Manager (`vp-vm`), create it on `vp-vm`'s [New Issue](github.com/46Dimensions/vp-vm/issues/new) page.

### Check if the issue already exists
Before creating an issue, please search in [Open Issues](https://github.com/46Dimensions/VocabularyPlus/issues/) (view the Open Issues page for `vp-vm` [here](github.com/46Dimensions/vp-vm/issues)) to see if a similar issue or feature request has been created already.
...
* Python version
* Vocabulary Plus version (use `vocabularyplus --version`)
